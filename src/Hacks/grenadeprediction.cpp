...
static bool CheckDetonate( const Vector& vecThrow, const trace_t& tr, int tick, float interval )
{
	...
	case (int)ItemDefinitionIndex::WEAPON_DECOY: // WEAPON_DECOY = 47,
		...
		return false;
	case (int)ItemDefinitionIndex::WEAPON_MOLOTOV: // WEAPON_MOLOTOV = 46,
	case (int)ItemDefinitionIndex::WEAPON_INCGRENADE: // WEAPON_INCGRENADE = 48,
		// Detonate when hitting the floor
		if ( tr.fraction != 1.0f && tr.plane.normal.z > 0.7f )
			return true;
		// OR we've been flying for too long
	case (int)ItemDefinitionIndex::WEAPON_FLASHBANG: // WEAPON_FLASHBANG = 43,
	case (int)ItemDefinitionIndex::WEAPON_HEGRENADE: // WEAPON_HEGRENADE = 44,
    ...
    int whatToDraw )
{
	...
	if ( Util::GetEpochTime() - lastCalled > 2000 )
	{ // Hack for it breaking on map change. might be false triggered by getting 0.5FPS.
