...
const char *Util::logFileName = "/tmp/deephook.log";
...
void __attribute__((destructor)) Shutdown()
{
	...
	*s_bOverridePostProcessingDisable = false;
	...
	cvar->ConsoleColorPrintf(ColorRGBA(255, 0, 0), XORSTR("DeepHook Unloaded successfully.\n"));
}
